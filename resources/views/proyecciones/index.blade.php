<div class="content-proyecciones">
    <h2 class="page-title"><i class="fas fa-rocket"></i> Proyección de casos futuros</h2>
    
    <div class="algo-card">
        <h3>
            <i class="fas fa-brain"></i> Algoritmo: Programación dinámica de aprendizaje (t=0.3) para proyección de casos futuros.
    ...
    <div class="chart-card">
        ...
        <div class="legend">
            ...
            <span class="legend-item">
                <span class="legend-dot" style="background:#ff8a5c; opacity:0.8;"></span> Proyección de casos futuros
            </span>
        </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (!canvas) {
        console.error('No se encontró el canvas #chartProyecciones');
        return;
    }

    // Inyección dinámica de variables desde Laravel usando @json
    const meses = @json($meses);
    const datosReales = @json($datosReales);
    const datosProyectados = @json($datosProyectados);
    ...
    new Chart(ctx, {
        ...
        data: {
            ...
            datasets: [
                ...
                {
                    label: 'Proyección de casos futuros',
        ...
        options: {
            ...
            scales: {
                x: {
                    grid: { display: false },
                    ticks: { color: '#4a6a85', font: { size: 12 } }
                },
                y: {
...
<style>
.content-proyecciones { max-width: 100%; }
...
.algo-card h3 { font-weight: 500; color: #1a2f44; font-size: 1.1rem; }
